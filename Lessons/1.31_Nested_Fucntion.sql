...
-- STRUCT
SELECT{skill: 'python'} AS skill_struct;
...
-- Build a flat skill table for co-workers to access job titles, salary info, and skills into one table
...
-- Array of Structs - Fibal Example
-- Build a flat & type table for co-workers to access job titles, salary info, skills adn type in one table
