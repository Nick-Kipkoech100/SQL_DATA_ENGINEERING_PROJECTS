-- Step4: Mar -Create skills demand mart
...
SELECT '=== Loading Skill Fact for Skill Mart ===' AS info;
...
SELECT 'Skill Dimensions' AS table_name, COUNT(*) as record_count FROM skills_mart.dim_skills
UNION ALL
