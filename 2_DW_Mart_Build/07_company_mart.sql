...
-- Gtan: companny_id + job_title_short + job_country + posted month
...
SELECT  company_id,
        ...
        -- ratio of postngs that mention health insurance
...
SELECT '=== Company Dimnesion Sample ===' AS info;
SELECT * FROM company_mart.dim_company LIMIT 5;

SELECT '=== Job Title Short Dimension Sample ===' AS info;
SELECT * FROM company_mart.dim_job_title_short LIMIT 15;
